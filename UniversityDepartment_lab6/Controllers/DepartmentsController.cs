...
namespace UniversityDepartment_lab6.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DepartmentsController : ControllerBase
    {
        private readonly UniversityDepartmentContext _context;

        public DepartmentsController(UniversityDepartmentContext context)
        {
            _context = context;
        }
